...
export const meta = {
  ...
  description: "Para usar React hay cargar el código de la librería. Ya sea desde un administrador de paquetes como npm o yarn, o en este ejemplo desde un CDN.",
  slug: "cargando-react-cdn",
  lang: "es",
...
Ya tenemos React y ReactDOM cargados en nuestro sitio web y listo para usarlo como podemos leer en [Hola Mundo con React](/essays/hola-mundo-react)
