...
export const meta = {
  ...
  slug: "medium/usando-ecmascript-6-2015-con-babel",
  date: "2015-06-09T00:00:00Z",
  description: "",
  published: true,
  lang: "es",
  canonicalUrl: "https://medium.com/@sergiodxa/usando-ecmascript-6-2015-con-babel-b9cc670b5636841",
  tags: [
  ]
}
...
Una de estas posibles herramientas es [Browserify](http://browserify.org/), este nos permite escribír nuestro código usando require(‘modulo’) para tener módulos como si fuese Node.js y luego generar un único archivo final que enviamos al navegador y funciona sin problemas.
...
Aunque ES6 todavía no esta totalmente soportado por los navegadores ya esta en desarrollo la siguiente versión del estandar desde el año pasado. Esta nueva versión, que incluso [Google Chrome soporta una de sus nuevas características](http://www.html5rocks.com/en/tutorials/es7/observe/), va a incorporar varias nuevas características y algunas de estas son soportadas de forma experimental por Babel.
...
Si deciden usar Babel para iniciar sus aplicaciones de Node.js usando ES6 y ES7 es posible hacer que en caso de error o de cambios en los archivos la aplicación se reinicie usando [Nodemon](http://nodemon.io/). Para esto hay que usar el comando:
...
Si quieren seguír investigando más sobre Babel pueden ir al [sitio oficial](http://babeljs.io/) donde pueden ver formas de [usarlo con otras herramientas](http://babeljs.io/docs/setup/) como Grunt, Webpack, Require.js, Meteor, Rails, Sails, Ember, WebStorm, etc.

Tienen además información sobre como usarlo más a fondo, como hacer un uso más avanzado y hasta una página donde pueden [probarlo en vivo](http://babeljs.io/repl/#?experimental=true&evaluate=true&loose=true&spec=false&playground=false&code=) incluso con las características de ES7.
