...
export const meta = {
  ...
  slug: "js-basics/array-prototype-filter",
  lang: "es",
...
Array#filter es usado un montón en JavaScript, especialmente cuando se trabaja de una forma funcional y en combinación con otros métodos como [Array#map](/essays/js-basics/array-prototype-filter). Es usado en React.js para filtras listas de datos en elementos de React, por ejemplo:
