...
[Siguiendo](/essays/react-props-valores-predefinidos) con el uso de _props_ vamos a definir como definir a que tipo de dato pertenecen nuestros props.
...
Ya vimos como hacer [un componente que use props](/essays/componentes-react-personalizables-props.mdx), [definir valores por defecto](/essays/react-props-valores-predefinidos) y ahora especificar el tipo de datos.

En próximos artículos [veremos como hacer composición de componentes de React](/essays/composicion-components-react).
