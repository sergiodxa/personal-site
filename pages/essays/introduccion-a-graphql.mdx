...
export const meta = {
  ...
  description: "En 2015 Facebook anunció GraphQL, una tecnología que empezaron a desarrollar y usar internamente en 2012. ¿Pero qué es GraphQL?",
...
```json
{
  "data": {
    "addToLearningPath": {
      "title": "Fundamentos de JavaScript",
      "badge":
        "https://static.platzi.com/media/achievements/badge-Fundamentos-js.png",
      "approved": false,
      "url": "https://platzi.com/clases/fundamentos-javascript/"
    }
  }
