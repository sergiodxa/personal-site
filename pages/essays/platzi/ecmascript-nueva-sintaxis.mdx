...
export const meta = {
  ...
  slug: "platzi/ecmascript-nueva-sintaxis",
  date: "2015-04-24T00:00:00Z",
  description: "",
  published: true,
  lang: "es",
  canonicalUrl: "https://platzi.com/blog/ecmascript-nueva-sintaxis/",
  tags: [
  ]
}
...
**Nota: el soporte para clases de ECMAScript 6 en los navegadores actualmente es nulo**, todavía está en desarrollo y no está listo para ser usado, hay sin embargo formas de escribir código usando ES6 y luego convertirlo a ES5 con resultados bastante buenos,* pero no es un soporte nativo, sigue siendo ES5*.
