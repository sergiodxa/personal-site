...
export const meta = {
  ...
  slug: "platzi/react-v014",
  date: "2015-07-08T00:00:00Z",
  description: "",
  published: true,
  lang: "es",
  canonicalUrl: "https://platzi.com/blog/react-v014/",
  tags: [
  ]
}
...
De esta forma, evitamos que se rompa el código actual y que, al momento de intentar usarlo, la consola nos muestre un _warning_ para dar aviso de que es necesario empezar a usar **react-dom**.  Sin embargo, en la versión 0.15 de React.js el **react-dom** pasará a ser obligatorio. Así se eliminarán tanto el warning, como los métodos de renderizado del módulo react.
