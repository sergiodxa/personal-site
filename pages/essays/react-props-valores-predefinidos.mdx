...
export const meta = {
  ...
  slug: "react-props-valores-predefinidos",
  lang: "es",
...
[En otro artículo](/essays/componentes-react-personalizables-props) vimos como hacer que nuestro componente sea personalizable usando _props_. Y definimos un valor como _fallback_ en caso de que este prop no tenga valor definido.
...
Listo, ahora estamos listos para [ver los diferentes tipos de datos en React](/essays/tipos-datos-react)
