...
export const meta = {
  ...
  slug: "componentes-react-hijos-personalizables",
  lang: "es",
...
[En el artículo anterior creamos `Header` e hicimos que renderice `Hello` internamente](/essays/composicion-componentes-react). Hoy vamos a hacer que el contenido de `Header` se pueda personalizar como un _prop_ de forma que podamos decidir si usar `Hello` o no.
...
[En el siguiente artículo vamos a ver más sobre este _prop_ `children`](/essays/react-prop-especial-children)
