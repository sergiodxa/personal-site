...
[En otro artículo vimos como cargar React y ReactDOM](/essays/cargando-react-cdn) con una etiqueta `<script >`. Hoy vamos a ver como usar React para renderizar nuestro primer elemento de React.
