...
export const meta = {
  ...
  slug: "cristalab/el-modulo-flexbox-de-css3",
  date: "2013-12-15T00:00:00Z",
  description: "",
  published: true,
  lang: "es",
  canonicalUrl: "http://www.cristalab.com/tutoriales/el-modulo-flexbox-de-css3-c112091l/",
  tags: [
    "Cristalab",
    "JavaScript",
    "OOP",
...
[Flexbox es un módulo de CSS3](http://www.cristalab.com/tags/css3/) que permite crear layouts flexibles de una forma más eficiente controlando la alineación de las cajas, el ancho y el alto para ocupar el espacio disponible. Un ejemplo simple es que con flexbox puedes hacer que todas las columnas de un sitio tengan el mismo alto y hasta hacer el responsive design mucho más fácil.
...
> La propiedad column de CSS no afecta a un flex container.
> float, clear y vertical-aling tampoco afecta a un flex container.
...
Este funciona exactamente igual que justify-content, pero sobre el cross axis permitiéndote definir qué hacer con el espacio que sobra.
Esta propiedad no surte efecto cuando flexbox es de solo una línea.
...
> [Demo](http://sergiodxa.github.io/FlexboxLayout/)
