...
export const meta = {
  ...
  slug: "cristalab/automatizando-tareas-frontend-gulp",
  date: "2014-12-22T00:00:00Z",
  description: "",
  published: true,
  lang: "es",
  canonicalUrl: "http://www.cristalab.com/tutoriales/automatizacion-de-tareas-de-frontend-usando-gulp.js-c114514l/",
  tags: [
    "Cristalab"
  ]
}
...
Gracias a herramientas como [Gulp.js](http://gulpjs.com/) y [Grunt.js](http://gruntjs.com/) ahora es posible automatizar todas estas tareas repetitivas e inicializarlas con un único comando en la terminal. En este tutorial les voy a explicar como usar una de estas herramientas, **Gulp.js**.

## Descargar e instalar Gulp.js

Lo primero que necesitamos hacer para empezar a usar Gulp.js es descargarlo e instalarlo, para esto necesitamos tener Node.js instalado, si no lo tienen pueden [ir al sitio](http://nodejs.org/), descargarlo e [instalarlo](http://www.cristalab.com/tutoriales/instalar-nodejs-y-paquetes-en-linux-y-windows-c104363l/). Una vez tengan Node.js simplemente abren la consola y escriben el comando para instalar Gulp.js de forma global.
...
Lo siguiente es buscar los plugins necesarios para nuestro proyecto, para eso pueden ir al [sitio de Gulp.js](http://gulpjs.com/plugins/) y en la sección de plugins tienen la lista completa con un buscador.

![Resultados de buscar plugins en gulpjs.com](http://l4c.me/uploads/sitio-de-gulpjs-1419221544_full550.png)

O pueden ir directamente a [NPM](http://npmjs.org/) y buscar ahí el plugin agregando la palabra gulp a su búsqueda.

Para este ejemplo vamos a compilar del pre-procesador [LESS](http://lesscss.org/) a CSS, además de minificar el CSS resultante y por último que si se cambian los archivos de LESS vuelva a compilar.
