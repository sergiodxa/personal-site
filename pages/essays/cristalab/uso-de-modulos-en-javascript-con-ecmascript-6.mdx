...
export const meta = {
  ...
  slug: "cristalab/uso-de-modulos-en-javascript-con-ecmascript-6",
  date: "2014-11-07T00:00:00Z",
  description: "",
  published: true,
  lang: "es",
  canonicalUrl: "http://www.cristalab.com/tutoriales/uso-de-modulos-en-javascript-con-ecmascript-6-c114342l/",
  tags: [
    "Cristalab",
    "JavaScript"
  ]
...
- ["Modules: Cycles" in the Node.js API documentation](http://nodejs.org/api/modules.html#modules_cycles)
