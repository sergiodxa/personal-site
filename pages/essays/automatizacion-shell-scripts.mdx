...
3. Instalar Yarn y Node.js
4. Clonar desde GitHub nuestro repositorio
...
run()
{
  print "Running project"
	cd ~/website && yarn start ; cd -
}
```

Eso es todo, mostramos un mensaje diciendo que vamos a correr el proyecto, nos movemos a la carpeta donde clonamos el repositorio y ejecutamos `yarn start` para iniciarlo. Al terminar va a volver a la carpeta inicial.
