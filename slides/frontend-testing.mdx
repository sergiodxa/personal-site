...
### HTML + CSS Regression Testing with Snapshots

> Use [Jest Snapshots](https://jestjs.io/docs/en/snapshot-testing) for regression testing of the **HTML and CSS output**.
...
> Use [Storybook](https://storybook.js.org) with [Storyshots](https://www.npmjs.com/package/@storybook/addon-storyshots) for **visual** regression testing.
