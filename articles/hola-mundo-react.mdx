...
next:
  ...
  description: Los componentes de React son la unidad básica de cualquier aplicación hecha con esta librería, aprende como crear y usar componentes de React.
---

[En otro artículo vimos como cargar React y ReactDOM](/articles/cargando-react-cdn) con una etiqueta `<script >`. Hoy vamos a ver como usar React para renderizar nuestro primer elemento de React.
