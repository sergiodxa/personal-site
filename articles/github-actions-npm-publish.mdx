...
description: Create a GitHub Actions workflow to automatically publish new version of a package when creating a new release on GitHub.
...
I have multiple packages in npm, like [flagged](https://github.com/sergiodxa/flagged) or [@contentz/build](https://github.com/contentz-tech/build), that I wanted to automate the publish.
