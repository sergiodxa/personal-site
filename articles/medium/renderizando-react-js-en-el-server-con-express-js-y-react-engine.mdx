...
[React.js](https://facebook.github.io/react/) cada vez es más popular en el mundo del desarrollo web y una de las razones de esto es que permite crear código isomórfico, esto quiere decír que funciona tanto en el cliente (navegador) como en el servidor.
