...
Algo muy molesto cuando estás [usando ES6 con Babel.js](/articles/medium/usando-ecmascript-6-2015-con-babel) y Gulp.js para automatizar tareas es que el archivo gulpfile.js sigue estando en ES5 y usando los módulos de CommonJS, aunque el resto de tu aplicación use ES6 y sus sistema de módulos.
