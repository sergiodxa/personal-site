...
description:
  Manejar flujos de datos asíncronos es complejo, pero con Promesas esto se
...
next:
  ...
  description:
    Manejar flujos de datos síncronos es fácil, con Promises también es fácil
    hacerlos asíncronos. Ahora veamos como combinarlos.
---
