...
published: true
lang: es
canonical_url: https://platzi.com/blog/que-es-y-como-funcionan-las-promesas-en-javascript/
tags: JavaScript, Promises, Async, ES2015, ES6
next:
  title: Mezclando flujos síncronos y asíncronos usando promesas en JavaScript
  path: /articles/mezclando-flujos-sincronos-y-asincronos
