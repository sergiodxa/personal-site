...
Son muchos pasos, pero no todos son realmente necesarios, con tener el `package.json` y el código es sufciente para hacer `publish`, en ese artículo fuimos un poco más allá agregando un build, pruebas automatizadas, linter y más cosas para asegurarnos de publicar un buen módulo lo más completo.
