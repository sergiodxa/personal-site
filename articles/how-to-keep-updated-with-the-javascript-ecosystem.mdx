...
I used to read a lot personal blogs, I still follow and read some blogs like [PonyFoo](https://ponyfoo.com/) or [2ality](http://2ality.com/). Most of them migrated to Medium or dev.to meaning you can get more articles there.
