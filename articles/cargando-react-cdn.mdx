...
description: En este tutorial vamos a ver como crear un Hola Mundo en React sin usar JSX.
lang: es
published: true
...
Lo primero que necesitamos hacer para usar React es cargar el código de la librería. Hay muchas formas, ya sea desde un administrador de paquetes como npm o [yarn](https://sdx.im/link/https://platzi.com/blog/manejo-de-dependencias-javascript-con-yarn), la forma más fácil y la recomendada para empezar a aprender React es cargarlo como a cualquier archivo JS, con una etiqueta `<script>`.
...
Ya tenemos React y ReactDOM cargados en nuestro sitio web y listo para usarlo como podemos leer en [Hola Mundo con React](/articles/hola-mundo-react)
