...
```sh
$ yarn add -D tailwindcss postcss-easy-import cssnano autoprefixer @fullhuman/postcss-purgecss
```

- [tailwindcss](https://www.npmjs.com/package/tailwindcss) - The CSS library itself
- [postcss-easy-import](https://www.npmjs.com/package/postcss-easy-import) - A PostCSS plugin to inline `@import` statements in CSS
- [cssnano](https://www.npmjs.com/package/cssnano) - A CSS minifier, it even minify CSS shorthands
...
That's all we need to add to this file, with this we are loading Tailwind base, components, and utility styles. We are also telling PurgeCSS to don't purge the base styles.

## Using Tailwind

Now that we have everything configured and our `styles.css` ready let's update our the basic components the `create-next-app` give us to use Tailwind instead.
...
This file will load our CSS one time and ensure it's always loaded.
