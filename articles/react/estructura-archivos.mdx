...
Creo hooks custom cada vez que necesito compartir comportamiento entre componentes y cuando estoy usando [SWR](https://swr.vercel.app) para crear hooks específicos para cada recurso de mi API.
