...
published: true
lang: es
canonical_url: https://www.cristalab.com/tutoriales/como-usar-la-etiqueta-template-en-html5-c114548l/
tags: Cristalab
---
...
Actualmente el uso de templates es posible del lado del Frontend usando JavaScript. Para manejar dichos los templates tenemos algunos engines como: [Jade](https://jade-lang.com/), Swig, [Mustache](https://mustache.github.io/), [Handlebars](https://handlebarsjs.com/), etc.

Gracias a la popularidad de estos motores de templates la [WhatWG](https://whatwg.org/) creó una etiqueta nueva en HTML5 poco conocida, que gracias a los [Web Components](https://webcomponents.org/) se está volviendo cada vez más popular, [la etiqueta `<template>`](https://www.whatwg.org/specs/web-apps/current-work/multipage/scripting-1.html#the-template-element).
...
Aunque la etiqueta `<template>` no tiene soporte en Internet Explorer es posible utilizarlo gracias a la librería [HTML5Shiv](https://github.com/aFarkas/html5shiv), que por cierto forma parte de de [Modernizr](https://modernizr.com/) por lo que si están usando este, entonces ya tienen HTML5Shiv y ya pueden usar la etiqueta `<template>`.
...
Pueden ver una demo del código de arriba en CodePen en el siguiente link: https://codepen.io/sergiodxa/pen/EaNwVz
