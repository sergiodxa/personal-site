...
with a Single Command](https://sergiodxa.com/slides/local-to-global) (una charla que dí en el FliSol de mi ciudad) están hechos usando MDX, cada slide es un archivo `.mdx` que usa Markdown común y corriento y en algunos slides especiales como [Global Regions
